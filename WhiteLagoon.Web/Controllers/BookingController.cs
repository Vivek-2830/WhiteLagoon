...
namespace WhiteLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IBookingService bookingService,
            ...
            IVillaNumberService villaNumberServices, UserManager<ApplicationUser> userManager)
        {
            _userManager = userManager;
            _webHostEnvironment = webHostEnvironment;
            _villaNumberService = villaNumberServices;
        ...
        public IActionResult BookingConfirmation(int bookingId)
        {
            ...
            return View("~/Views/Booking/BookingConfirmation.cshtml",bookingId);
        }
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            textRange = textSelection.GetAsOneRange();
            textRange.Text = "BOOKIND ID - " + bookingFromDb.Id;
            textSelection = document.Find("XX_BOOKING_DATE", false, true);
            textRange = textSelection.GetAsOneRange();
            textRange.Text = "BOOKING DATE - " + bookingFromDb.BookingDate.Value.ToShortDateString();
            ...
            row0.Cells[2].AddParagraph().AppendText("PRICE PERR NIGHT");
            ...
            row1.Cells[1].AddParagraph().AppendText(bookingFromDb.Villa.ToString());
            ...
            if (bookingFromDb.VillaNumber > 0)
            {
                ...
                row1.Cells[0].Width = 80;
                row2.Cells[1].AddParagraph().AppendText("VillaNumber -" + bookingFromDb.VillaNumber.ToString());
        ...
        {
            _bookingService.UpdateStatus(booking.Id, SD.StatusCancellled, 0);
            TempData["Success"] = "Booking Cancellled Successfully.";
            return RedirectToAction(nameof(BookingDetails), new { bookingId = booking.Id });
        }
        private List<int> AssignAvailableVillaNumberByVilla(int villaId)
        {
            ...
            var checkedInVilla = _bookingService.GetCheckedInVillaInNumbers(villaId);
